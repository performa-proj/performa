            ...
            {isLoading ? (
              ...
              >
                <td className="px-3 py-4 text-sm font-medium text-gray-900">
                  ...
                  <dl className="mt-2 sm:hidden font-normal">
                ...
                <td className="hidden sm:table-cell px-3 py-4 text-sm font-medium text-gray-900">
                  <p className="divide-x divide-gray-200">
                    {each.levels.map((level, index) => (
                      <span
                        key={index}

...
const DataTypes = [
  { id: 1, name: "Customers", initial: "C", title: "Customers", href: "/data/customers" },
  { id: 2, name: "Products", initial: "P", title: "Products", href: "/data/products" },
  { id: 3, name: "Price Structures", initial: "PS", title: "Price Structures", href: "/data/pricestructures" },
  { id: 4, name: "Users", initial: "U", title: "Users", href: "/data/users" },
];
...
const Navs = ({
  ...
  <nav className="flex flex-1 flex-col">
    <ul role="list" className="flex flex-1 flex-col gap-y-7">
      <li>
        <div className="text-xs/6 font-semibold text-gray-600">Managed Data</div>
...
export default function ManagedOrdersLayout({
  ...
  const matched = DataTypes.find((each) => each.href === pathname);

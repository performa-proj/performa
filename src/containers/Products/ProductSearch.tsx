...
export default function ProductSearch({
  ...
  return (
    <div className={classnames(
      ...
      "flex items-center rounded-md px-3 outline-1 -outline-offset-1 outline-gray-300 focus-within:outline-2 focus-within:-outline-offset-2 focus-within:outline-blue-600"
    )}>
